...
## Addendum: Studio AI & Prose Conversion

---

## 13. Studio AI: Role & Boundaries (Critical)

### 13.1 What the Studio AI Is

The **Studio AI** is an **authoring assistant**, not a DM and not a runtime actor.

Its purpose is to:

- Accelerate content creation  
- Enforce spec compliance  
- Help humans translate prose into structured narrative systems  

The Studio AI operates strictly inside constraints defined by the spec.

---

### 13.2 What the Studio AI Is Not
...
- Does not execute stories  

If the AI produces content:

- It must still validate  
- It must still be editable by humans  
- It must still map to explicit spec constructs  

---

### 13.3 Studio AI Capabilities

The Studio AI may assist in creating:
...
- Scene transitions  
- Available actions  
- Descriptive prose within scene constraints  

It may refactor:

- Overlong prose into scene chunks  
- Flat narrative into branching structures  

All AI output is:

- Draft  
- Reviewable  
- Explicitly attributed to AI assistance  
